						...
						<div
							...
							<div class="cart_item_product d-flex flex-row align-items-center justify-content-start">
								...
								<div class="cart_item_name_container">
									<div class="cart_item_name"><a href="#">{{$destinations->title}}</a></div>
									<div class="cart_item_edit"><a href="#">Edit Product</a></div>
								</div>
							</div>
							<!-- Price -->
							<div class="cart_item_price">{{$destinations->pricing}}</div>
							<!-- Quantity -->
							...
							<!-- Total -->
							<div class="cart_item_total">{{$destinations->pricing}}</div>
						</div>
				...
				<div class="row row_cart_buttons">
					<div class="col">
						<div
							...
							<div class="button continue_shopping_button"><a href="#">More
									destinations</a></div>
							<div class="cart_buttons_right ml-lg-auto">
								<div class="button clear_cart_button"><a
										href="#">Clear cart</a></div>
				...
				<div class="row row_extra">
					...
					<div class="col-lg-6 offset-lg-2">
						<div class="cart_total">
							...
							<div class="button checkout_button"><a href="#">Proceed to checkout</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="ftco-footer-widget mb-4">
			...
			<div class="block-23 mb-3">
				<ul>
					...
					<li><a href="#"><span class="icon icon-phone"></span><span class="text">+254712345678</span></a>
					</li>
